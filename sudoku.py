...
class Game:
    ...
    def greet():
        ...
        Напишите 'New' для новой игры
                 ...
                 'Next' для следущего шага компьюетра (только режим 2)
        """, end='')
...
"""
1. Улучшенная проверка на некорректное введенное значение (цифры от 1 до 9)
3. Улучшенная проверка на вводимые цифры строки и столбца
"""
